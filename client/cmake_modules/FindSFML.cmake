...
# -----
#
# When you try to locate the SFML libraries, you must specify which modules you want to use (systems, window, graphics, network, audio, main).
# If none is given, the SFML_LIBRARIES variable will be empty and you'll end up linking to nothing.
# example:
#   find_package(SFML COMPONENTS graphics window systems) # find the graphics, window and systems modules
#
...
#   find_package(SFML 2 COMPONENTS network systems)
#
...
# - For each specified module XXX (systems, window, graphics, network, audio, main):
...
#
# example:
#   find_package(SFML 2 COMPONENTS systems window graphics audio REQUIRED)
...
if(SFML_STATIC_LIBRARIES)
    ...
    if(NOT ${FIND_SFML_SYSTEM_COMPONENT} EQUAL -1)
        ...
        # update the list -- these are only systems libraries, no need to find them

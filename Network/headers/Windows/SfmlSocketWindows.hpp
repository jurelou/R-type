...
#ifndef CPP_SFMLSOCKETWINDOWS_HPP
#define CPP_SFMLSOCKETWINDOWS_HPP
...
class	    SfmlSocketWindows : public ISocket
{
public:
    virtual ~SfmlSocketWindows();
	SfmlSocketWindows();
...
#endif //CPP_SFMLSOCKETWINDOWS_HPP
